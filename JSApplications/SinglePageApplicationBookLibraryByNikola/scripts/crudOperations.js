...
const APP_KEY = 'kid_SJBrzi_4Q'
const APP_SECRET = '3dbf7891edc149eba722ccc682363cb7'
...
function displayPaginationAndBooks(books) {
    ...
    pagination.twbsPagination({
        ...
        onPageClick: function (event, page) {
            $('#books > table tr').each((index, element) => {  //clear all old books
...
function loadBookForEdit(book) {
    ...
    $('#formEditBook input[name="id"]').val(book._id)                          //set bookId for editing we need it
}
function editBook() {
    ...
    let id = $('#formEditBook input[name="id"]').val()                       //it is hidden
    $.ajax({
        method: 'PUT',
